...
public abstract class Policy {
	...
	/** Adding fix search depth and gradient update version **/
	static public boolean fixSetting2022;
	static public int fixDepthSetting;
	static public int fixGradientUpdates;	
	/** End adding **/
	...
	/** Add fixed search depth and gradient update version */
	public void setFixSetting2022(boolean _sFixSetting2022, int _sFixDepthSetting, int _sFixGradientUpdates) {
		fixSetting2022 = _sFixSetting2022;
		fixDepthSetting = _sFixDepthSetting;
		fixGradientUpdates = _sFixGradientUpdates;
	}
	/** End add */
